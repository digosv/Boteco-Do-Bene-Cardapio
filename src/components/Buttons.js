...
const Buttons = () => {
  ...
  return (
    <div className="rounded-3xl text-1xl bg-white text-black grid grid-flow-col auto-cols-max w-5/7 mt-5 ml-3 mr-3 overflow-x-scroll scroll-persistent md:text-1xl md:items-center md:justify-center shadow-lg">
      <motion.div
