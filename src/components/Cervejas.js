...
const Cervejas = () => {
    return (
        <div className="grid grid-cols-2 ml-4 md:grid-cols-5">
           ...
           <MenuOption local={duplomalte} nome="Duplomalte" preco='R$ 12,00'></MenuOption>
           <MenuOption local={amstel} nome="Amstel" preco='R$ 12,00'></MenuOption>
           <MenuOption local={antartica} nome="Antartica" preco='R$ 12,00'></MenuOption>
           <MenuOption local={brahma} nome="Brahma" preco='R$ 12,00'></MenuOption>
           <MenuOption local={corona} nome="Corona Long Neck" preco='R$ 13,00'></MenuOption>
           <MenuOption local={imperio} nome="Imperio" preco='R$ 12,00'></MenuOption>
           <MenuOption local={imperiolager} nome="Imperio Lager" preco='R$ 12,00'></MenuOption>
           <MenuOption local={serramalte} nome="Serramalte" preco='R$ 16,00'></MenuOption>
           <MenuOption local={spaten} nome="Spaten" preco='R$ 15,00'></MenuOption>
           <MenuOption local={stella} nome="Stella Artois" preco='R$ 15,00'></MenuOption>
        </div>
    );
}
